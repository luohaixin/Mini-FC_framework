  ...
  setup() {
    ...
    return () =>
      h('div', null, [
        ...
        // Card 组件使用示例
        h(Card, { title: 'Card Title' }, [h('p', null, 'Card content goes here')])
      ]);
  }
});
```
...
| Workflow    | 触发条件                  | 功能                                |
| ----------- | ------------------------- | ----------------------------------- |
| **CI**      | PR / Push 到 main/develop | 代码检查、测试、构建验证            |
| **Release** | 推送 v\* 标签             | 自动发布到 npm、创建 GitHub Release |
